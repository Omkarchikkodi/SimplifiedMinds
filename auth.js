...
window.login = function () {
    ...
    signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            // ✅ Handle missing display name case
            const displayName = user.displayName || localStorage.getItem("userName") || "User";
        ...
        .then((userCredential) => {
            ...
            return updateProfile(user, { displayName: name })
                ...
                .catch((error) => {
                    ...
                    showToast("❌ Could not update profile. Please update your name in settings.");
                });
        })
        .catch((error) => {
